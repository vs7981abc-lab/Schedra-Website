      ...
      >
          ...
          <div className="flex items-center gap-3 pt-4 border-t border-slate-900/80 w-full justify-center lg:justify-start">
            ...
            <div className="flex flex-col gap-0.5">
              ...
              <span className="text-slate-400 text-xs">
                Trusted by{' '}
                <span className="text-white font-semibold">5,000+ users</span>{' '}
                worldwide
              </span>
            </div>
          </div>
        ...
        >
          ...
          >
            ...
            <div className="min-w-0">
              <p className="text-[10px] sm:text-[11px] font-bold text-white leading-tight truncate">GYM Planner</p>
              <p className="text-[9px] sm:text-[10px] text-slate-400 leading-tight mt-0.5">Workout scheduling</p>
            </div>
          </motion.div>
